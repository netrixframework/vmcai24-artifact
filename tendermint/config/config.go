...
type P2PConfig struct { //nolint: maligned
	...
	NetrixAddr          string `mapstructure:"netrix-addr"`
	NetrixClientAddr    string `mapstructure:"netrix-client-addr"`
	NetrixClientAdvAddr string `mapstructure:"netrix-client-adv-addr"`
}
...
func DefaultP2PConfig() *P2PConfig {
	return &P2PConfig{
		...
		QueueType:               "priority",
		NetrixAddr:              "127.0.0.1:8080",
		NetrixClientAddr:        "127.0.0.1:8081",
		NetrixClientAdvAddr:     "",
	}
}
...
type ConsensusConfig struct {
	...
	NetrixTimer bool `mapstructure:"netrix-timer"`
