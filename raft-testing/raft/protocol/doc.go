...
/*
package protocol sends and receives messages in the Protocol Buffer format
...
package protocol sends and receives message in Protocol Buffer format (defined
